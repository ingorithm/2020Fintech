...
# def getAIAData(name, birth, gender): #유관우 , 19890119 , 0 남자 1 여자
#     driver = webdriver.Chrome('./chromedriver')
#     driver.get('https://www.aia.co.kr/ko/our-products/medical-protection/non-par-denteal-health-plan.html#')

#     femaleImg = driver.find_element_by_xpath('//*[@id="calculator-container-form"]/div[1]/div[2]/div/div[1]/div/div[3]/div[1]/div[1]/label/div/div[2]/svg/g/image')
#     maleImg = driver.find_element_by_xpath('//*[@id="calculator-container-form"]/div[1]/div[2]/div/div[1]/div/div[3]/div[1]/div[2]/label/div/div[1]/svg/g/image')
#     birthDate = Select(driver.find_element_by_xpath('//*[@id="aia644363719"]'))
...
#     else :
#         femaleImg.click()
#     birthDate.send_keys(birth)
#     calculate.click()

#     return

# getAIAData('ingu', 19941025, 0)
